...
public class Base64 extends BaseNCodec {
        ...
        if (!context.eof) {
                ...
                if (context.modulus != 0 || this.lineLength != 0) {
                    ...
                    switch (context.modulus) {
                        ...
                        case 1:
                            ...
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = this.encodeTable[(context.ibitWorkArea << 4) & 63];
                        ...
                        case 2:
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = this.encodeTable[(context.ibitWorkArea >> 10) & 63];
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = this.encodeTable[(context.ibitWorkArea >> 4) & 63];
                            i = context.pos;
            ...
            while (i2 < inAvail) {
                ...
                if (context.modulus == 0) {
                    i = context.pos;
                    context.pos = i + 1;
                    buffer[i] = this.encodeTable[(context.ibitWorkArea >> 18) & 63];
                    i = context.pos;
                    context.pos = i + 1;
                    buffer[i] = this.encodeTable[(context.ibitWorkArea >> 12) & 63];
                    i = context.pos;
                    context.pos = i + 1;
                    buffer[i] = this.encodeTable[(context.ibitWorkArea >> 6) & 63];
                    i = context.pos;
                    context.pos = i + 1;
                    buffer[i] = this.encodeTable[context.ibitWorkArea & 63];
                ...
                if (b >= (byte) 0 && b < DECODE_TABLE.length) {
                    ...
                    if (result >= 0) {
                        ...
                        if (context.modulus == 0) {
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = (byte) ((context.ibitWorkArea >> 16) & 255);
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = (byte) ((context.ibitWorkArea >> 8) & 255);
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = (byte) (context.ibitWorkArea & 255);
                        }
                    }
                }
                i2++;
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked, boolean urlSafe) {
        return encodeBase64(binaryData, isChunked, urlSafe, ConstraintAnchor.ANY_GROUP);
    }
