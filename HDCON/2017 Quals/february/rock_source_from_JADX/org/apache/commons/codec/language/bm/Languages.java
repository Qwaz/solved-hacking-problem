...
public class Languages {
    ...
    public static final LanguageSet ANY_LANGUAGE = new C00162();
    private static final Map<NameType, Languages> LANGUAGES = new EnumMap(NameType.class);
    public static final LanguageSet NO_LANGUAGES = new C00151();
    ...
    static class C00151 extends LanguageSet {
        C00151() {
        }
    ...
    static class C00162 extends LanguageSet {
        C00162() {
        }
