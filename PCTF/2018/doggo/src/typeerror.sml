...
sig
    ...
    val publicIfBranches : exn
    val leakyIfBranches : exn
...
val publicIfBranches =
  TypeError "branches of an if statement depend on private value, but are not private"

val leakyIfBranches =
  TypeError "A branch of an if statement may leak information"
