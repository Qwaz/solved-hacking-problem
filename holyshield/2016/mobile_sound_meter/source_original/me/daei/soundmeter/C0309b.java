...
public class C0309b {
    public static int m2872a(char c) {
        ...
        return (((char) i2) < '!' || ((char) i2) > '/') ? (((char) i2) < 'a' || ((char) i2) > 'o') ? (((char) i2) < 'A' || ((char) i2) > 'O') ? (((char) i2) < '0' || ((char) i2) > ':') ? (((char) i2) < 'P' || ((char) i2) > 'Z') ? (((char) i2) < 'p' || ((char) i2) > 'z') ? i2 : i2 - 64 : i2 + 32 : i2 + 32 : i2 - 32 : i2 - 32 : i2 + 64;
    }
}
