...
def play():
    ...
    try:
        ...
        # stack = uc.mem_read(STACK, 0x1000)
        # for offset in range(0, 0x1000, 8):
        #     print("%s: %s" % (hex(offset), hex(u64(stack[offset : offset + 8]))))

        print(hex(uc.reg_read(UC_X86_REG_RIP)))
        print(hex(uc.reg_read(UC_X86_REG_CR0)))
        print(hex(uc.reg_read(UC_X86_REG_CR1)))
        print(hex(uc.reg_read(UC_X86_REG_CR2)))
        print(hex(uc.reg_read(UC_X86_REG_CR3)))
        print(hex(uc.reg_read(UC_X86_REG_CR4)))
