...
var sess = {
  secret: 'xcvynrusntuyxcnvyuml9whmysl8mlxclmt9lrmv8xclm89vlm9r9',
  cookie: {},
  resave: false,
...
router.get('/persistent', async (req, res) => {
  ...
  if (req.session.counter) {
    ...
    try{previousState =            sanitizedRead(fname)} catch (e) {;}
...
function sanitizedRead(fname) {
  if (FS.realpathSync(fname, 'utf-8') == '/flag') {
