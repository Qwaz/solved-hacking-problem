!(function () {
  for (
    var createModuleFactory = function (e) {
        var t;
        return function (o) {
          return t || e((t = { exports: {}, parent: o }), t.exports), t.exports;
        };
      },
      _$buffer_2 = createModuleFactory(function (e, t) {
        (function (e) {
          "use strict";
          ...
          function n(t, o, n) {
            ...
            if (D(t, ArrayBuffer) || (t && D(t.buffer, ArrayBuffer)))
              return (function (t, o, r) {
                if (o < 0 || t.byteLength < o)
                  throw new RangeError('"offset" is outside of buffer bounds');
                if (t.byteLength < o + (r || 0))
                ...
                return (
                  ((n =
                    void 0 === o && void 0 === r
                      ...
                      : void 0 === r
                      ? new Uint8Array(t, o)
                      : new Uint8Array(t, o, r)).__proto__ = e.prototype),
                  n
                );
              })(t, o, n);
            if ("number" == typeof t)
            ...
            if (null != i && i !== t) return e.from(i, o, n);
            var s = (function (t) {
              if (e.isBuffer(t)) {
                var o = 0 | a(t.length),
                  n = r(o);
            ...
            if (
              ...
              return e.from(t[Symbol.toPrimitive]("string"), o, n);
            throw new TypeError(
              "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
                typeof t
            );
          ...
          function g(e) {
            for (
              var t = e.length < 0 ? 0 : 0 | a(e.length), o = r(t), n = 0;
              n < t;
              n += 1
            )
              o[n] = 255 & e[n];
          ...
          function c(t, o, r, n, i) {
            ...
            if (("string" == typeof o && (o = e.from(o, n)), e.isBuffer(o)))
              return 0 === o.length ? -1 : p(t, o, r, n, i);
            if ("number" == typeof o)
              return (
                (o &= 255),
                "function" == typeof Uint8Array.prototype.indexOf
                  ? i
                    ? Uint8Array.prototype.indexOf.call(t, o, r)
                    : Uint8Array.prototype.lastIndexOf.call(t, o, r)
                  : p(t, [o], r, n, i)
              );
            ...
            if (n) {
              ...
              for (i = o; i < g; i++)
                if (l(e, i) === l(t, -1 === u ? 0 : i - u)) {
                  if ((-1 === u && (u = i), i - u + 1 === a)) return u * s;
                } else -1 !== u && (i -= i - u), (u = -1);
            } else
              for (o + a > g && (o = g - a), i = o; i >= 0; i--) {
          ...
          function d(e, t, o, r) {
            ...
            r > i / 2 && (r = i / 2);
            for (var s = 0; s < r; ++s) {
              var g = parseInt(t.substr(2 * s, 2), 16);
              if (B(g)) return s;
              e[o + s] = g;
            }
            return s;
          ...
          function b(e, t, o) {
            return 0 === t && o === e.length
              ? _$base64Js_1.fromByteArray(e)
              : _$base64Js_1.fromByteArray(e.slice(t, o));
          }
          function S(e, t, o) {
            ...
            return (function (e) {
              ...
              for (var o = "", r = 0; r < t; )
                o += String.fromCharCode.apply(String, e.slice(r, (r += E)));
              return o;
            })(r);
          }
          (e.TYPED_ARRAY_SUPPORT = (function () {
            ...
            (e.compare = function (t, o) {
              if (
                ...
                D(o, Uint8Array) && (o = e.from(o, o.offset, o.byteLength)),
                !e.isBuffer(t) || !e.isBuffer(o))
              )
                throw new TypeError(
              ...
              if (t === o) return 0;
              for (
                var r = t.length, n = o.length, i = 0, s = Math.min(r, n);
                i < s;
                ++i
              )
                if (t[i] !== o[i]) {
            ...
            (e.concat = function (t, o) {
              ...
              var r;
              if (void 0 === o)
                for (o = 0, r = 0; r < t.length; ++r) o += t[r].length;
              var n = e.allocUnsafe(o),
                i = 0;
            ...
            (e.prototype.compare = function (t, o, r, n, i) {
              if (
                (D(t, Uint8Array) && (t = e.from(t, t.offset, t.byteLength)),
                !e.isBuffer(t))
              )
              ...
              if (
                ...
                o < 0 || r > t.length || n < 0 || i > this.length)
              )
            ...
            (e.prototype.includes = function (e, t, o) {
              return -1 !== this.indexOf(e, t, o);
            }),
            (e.prototype.indexOf = function (e, t, o) {
              return c(this, e, t, o, !0);
            }),
            (e.prototype.lastIndexOf = function (e, t, o) {
              return c(this, e, t, o, !1);
            }),
            (e.prototype.write = function (e, t, o, r) {
          ...
          function O(e, t, o) {
            for (var r = e.slice(t, o), n = "", i = 0; i < r.length; i += 2)
          ...
          function v(e, t, o, r, n) {
            return (
              ...
              (o >>>= 0),
              n || I(e, 0, o, 4),
              _$ieee754_4.write(e, t, o, r, 23, 4),
              o + 4
            );
          }
          function N(e, t, o, r, n) {
            return (
              ...
              (o >>>= 0),
              n || I(e, 0, o, 8),
              _$ieee754_4.write(e, t, o, r, 52, 8),
              o + 8
            );
          }
          (e.prototype.slice = function (t, o) {
            ...
            (t = ~~t) < 0 ? (t += r) < 0 && (t = 0) : t > r && (t = r),
              (o = void 0 === o ? r : ~~o) < 0
                ...
                : o > r && (o = r),
              o < t && (o = t);
            var n = this.subarray(t, o);
            return (n.__proto__ = e.prototype), n;
          }),
            (e.prototype.readUIntLE = function (e, t, o) {
              (e >>>= 0), (t >>>= 0), o || w(e, t, this.length);
              for (var r = this[e], n = 1, i = 0; ++i < t && (n *= 256); )
                r += this[e + i] * n;
              return r;
            }),
            (e.prototype.readUIntBE = function (e, t, o) {
              (e >>>= 0), (t >>>= 0), o || w(e, t, this.length);
            ...
            (e.prototype.readIntLE = function (e, t, o) {
              (e >>>= 0), (t >>>= 0), o || w(e, t, this.length);
              for (var r = this[e], n = 1, i = 0; ++i < t && (n *= 256); )
                r += this[e + i] * n;
              return r >= (n *= 128) && (r -= Math.pow(2, 8 * t)), r;
            }),
            (e.prototype.readIntBE = function (e, t, o) {
              (e >>>= 0), (t >>>= 0), o || w(e, t, this.length);
            ...
            (e.prototype.readFloatLE = function (e, t) {
              return (
                (e >>>= 0),
                t || w(e, 4, this.length),
                _$ieee754_4.read(this, e, !0, 23, 4)
              );
            }),
            (e.prototype.readFloatBE = function (e, t) {
              return (
                (e >>>= 0),
                t || w(e, 4, this.length),
                _$ieee754_4.read(this, e, !1, 23, 4)
              );
            }),
            (e.prototype.readDoubleLE = function (e, t) {
              return (
                (e >>>= 0),
                t || w(e, 8, this.length),
                _$ieee754_4.read(this, e, !0, 52, 8)
              );
            }),
            (e.prototype.readDoubleBE = function (e, t) {
              return (
                (e >>>= 0),
                t || w(e, 8, this.length),
                _$ieee754_4.read(this, e, !1, 52, 8)
              );
            }),
            (e.prototype.writeUIntLE = function (e, t, o, r) {
              (e = +e),
                (t >>>= 0),
                (o >>>= 0),
                r || j(this, e, t, o, Math.pow(2, 8 * o) - 1, 0);
              var n = 1,
                i = 0;
            ...
            (e.prototype.writeUIntBE = function (e, t, o, r) {
              (e = +e),
                (t >>>= 0),
                (o >>>= 0),
                r || j(this, e, t, o, Math.pow(2, 8 * o) - 1, 0);
            ...
            (e.prototype.writeUInt8 = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
            ...
            (e.prototype.writeUInt16LE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
            ...
            (e.prototype.writeUInt16BE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 2, 65535, 0),
            ...
            (e.prototype.writeUInt32LE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 4, 4294967295, 0),
                (this[t + 3] = e >>> 24),
                (this[t + 2] = e >>> 16),
                (this[t + 1] = e >>> 8),
                (this[t] = 255 & e),
            ...
            (e.prototype.writeUInt32BE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 4, 4294967295, 0),
            ...
            (e.prototype.writeIntLE = function (e, t, o, r) {
              if (((e = +e), (t >>>= 0), !r)) {
              ...
              for (this[t] = 255 & e; ++i < o && (s *= 256); )
                e < 0 && 0 === g && 0 !== this[t + i - 1] && (g = 1),
                  (this[t + i] = (((e / s) >> 0) - g) & 255);
              return t + o;
            }),
            (e.prototype.writeIntBE = function (e, t, o, r) {
              if (((e = +e), (t >>>= 0), !r)) {
                var n = Math.pow(2, 8 * o - 1);
                j(this, e, t, o, n - 1, -n);
              }
            ...
            (e.prototype.writeInt8 = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
            ...
            (e.prototype.writeInt16LE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
            ...
            (e.prototype.writeInt16BE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 2, 32767, -32768),
            ...
            (e.prototype.writeInt32LE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 4, 2147483647, -2147483648),
                (this[t] = 255 & e),
                (this[t + 1] = e >>> 8),
                (this[t + 2] = e >>> 16),
                (this[t + 3] = e >>> 24),
            ...
            (e.prototype.writeInt32BE = function (e, t, o) {
              return (
                (e = +e),
                (t >>>= 0),
                o || j(this, e, t, 4, 2147483647, -2147483648),
            ...
            (e.prototype.writeFloatLE = function (e, t, o) {
              return v(this, e, t, !0, o);
            }),
            (e.prototype.writeFloatBE = function (e, t, o) {
              return v(this, e, t, !1, o);
            }),
            (e.prototype.writeDoubleLE = function (e, t, o) {
              return N(this, e, t, !0, o);
            }),
            (e.prototype.writeDoubleBE = function (e, t, o) {
              return N(this, e, t, !1, o);
            }),
            (e.prototype.copy = function (t, o, r, n) {
              if (!e.isBuffer(t))
              ...
              n > this.length && (n = this.length),
                t.length - o < n - r && (n = t.length - o + r);
              var i = n - r;
              if (
                this === t &&
                "function" == typeof Uint8Array.prototype.copyWithin
              )
                this.copyWithin(o, r, n);
              else if (this === t && r < o && o < n)
                for (var s = i - 1; s >= 0; --s) t[s + o] = this[s + r];
              else Uint8Array.prototype.set.call(t, this.subarray(r, n), o);
              return i;
            }),
            (e.prototype.fill = function (t, o, r, n) {
              if ("string" == typeof t) {
                if (
                  ("string" == typeof o
                    ? ((n = o), (o = 0), (r = this.length))
              ...
              if (
                ...
                for (s = o; s < r; ++s) this[s] = t;
              else {
                var g = e.isBuffer(t) ? t : e.from(t, n),
                  a = g.length;
                if (0 === a)
                  throw new TypeError(
                    'The value "' + t + '" is invalid for argument "value"'
                  );
                for (s = 0; s < r - o; ++s) this[s + o] = g[s % a];
              }
              return this;
            });
          var C = /[^+/0-9A-Za-z-_]/g;
          ...
          function M(e) {
            return _$base64Js_1.toByteArray(
              (function (e) {
                if (
          ...
          function L(e, t, o, r) {
            for (var n = 0; n < r && !(n + o >= t.length || n >= e.length); ++n)
              t[n + o] = e[n];
            return n;
          }
          function D(e, t) {
      ...
      _$base64Js_1 = {
        toByteArray: function (e) {
          ...
          for (o = 0; o < a; o += 4)
            (t =
              (revLookup[e.charCodeAt(o)] << 18) |
              (revLookup[e.charCodeAt(o + 1)] << 12) |
              (revLookup[e.charCodeAt(o + 2)] << 6) |
              revLookup[e.charCodeAt(o + 3)]),
              (s[g++] = (t >> 16) & 255),
              (s[g++] = (t >> 8) & 255),
              (s[g++] = 255 & t);
          return (
            2 === i &&
              ((t =
                (revLookup[e.charCodeAt(o)] << 2) |
                (revLookup[e.charCodeAt(o + 1)] >> 4)),
              (s[g++] = 255 & t)),
            1 === i &&
              ((t =
                (revLookup[e.charCodeAt(o)] << 10) |
                (revLookup[e.charCodeAt(o + 1)] << 4) |
                (revLookup[e.charCodeAt(o + 2)] >> 2)),
              (s[g++] = (t >> 8) & 255),
              (s[g++] = 255 & t)),
            s
          );
        ...
        fromByteArray: function (e) {
          for (
            var t, o = e.length, r = o % 3, n = [], i = 0, s = o - r;
            i < s;
            i += 16383
          )
            n.push(encodeChunk(e, i, i + 16383 > s ? s : i + 16383));
          return (
            1 === r
              ? ((t = e[o - 1]),
                n.push(lookup[t >> 2] + lookup[(t << 4) & 63] + "=="))
              : 2 === r &&
                ((t = (e[o - 2] << 8) + e[o - 1]),
                n.push(
                  lookup[t >> 10] +
  ...
  var _$ieee754_4 = {
      read: function (e, t, o, r, n) {
        var i,
          ...
          d = e[t + c];
        for (
          c += p, i = d & ((1 << -u) - 1), d >>= -u, u += g;
          u > 0;
          i = 256 * i + e[t + c], c += p, u -= 8
        );
        for (
          s = i & ((1 << -u) - 1), i >>= -u, u += r;
          u > 0;
          s = 256 * s + e[t + c], c += p, u -= 8
        );
        if (0 === i) i = 1 - l;
        else {
          ...
          t = Math.abs(t),
            isNaN(t) || t === 1 / 0
              ...
              : ((s = Math.floor(Math.log(t) / Math.LN2)),
                ...
                (t += s + c >= 1 ? p / a : p * Math.pow(2, 1 - c)) * a >= 2 &&
                  (s++, (a /= 2)),
                s + c >= u
                  ? ((g = 0), (s = u))
                  : s + c >= 1
                  ? ((g = (t * a - 1) * Math.pow(2, n)), (s += c))
                  : ((g = t * Math.pow(2, c - 1) * Math.pow(2, n)), (s = 0)));
          n >= 8;
          e[o + d] = 255 & g, d += f, g /= 256, n -= 8
        );
        for (
          s = (s << n) | g, l += n;
          l > 0;
          e[o + d] = 255 & s, d += f, s /= 256, l -= 8
        );
        e[o + d - f] |= 128 * h;
      },
    },
          ...
          return (
            ...
            function (e, t) {
              ...
              var r = o.length,
                n = e.length;
              t = Math.max(0, Math.min(0 | t, o.length));
              for (var i = 0; i < n && t < r; ) if (o[t++] != e[i++]) return !1;
              return i >= n;
            }
          );
        },
    ...
    (goog.global = this || self),
      ...
      (goog.base = function (e, t, o) {
        ...
        if (void 0 !== r.superClass_) {
          for (
            var n = Array(arguments.length - 1), i = 1;
            i < arguments.length;
            i++
          )
            n[i - 1] = arguments[i];
        ...
        for (n = Array(arguments.length - 2), i = 2; i < arguments.length; i++)
          n[i - 2] = arguments[i];
        i = !1;
        for (var s = e.constructor.prototype; s; s = Object.getPrototypeOf(s))
          if (s[t] === r) i = !0;
          else if (i) return s[t].apply(e, n);
      ...
      !COMPILED &&
        ...
        (goog.DependencyFactory.prototype.createDependency = function (
          ...
          return n.module == goog.ModuleType.GOOG
            ? new goog.GoogModuleDependency(e, t, o, r, n, i, this.transpiler)
            : i
    ...
    (jspb.BinaryConstants.FieldType = {
      ...
      (goog.array.forEach =
        ...
        (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.forEach)
          ...
          : function (e, t, o) {
              for (
                var r = e.length, n = goog.isString(e) ? e.split("") : e, i = 0;
                i < r;
                i++
              )
      ...
      (goog.array.range = function (e, t, o) {
        var r = [],
          n = 0,
          i = e;
        if ((void 0 !== t && ((n = e), (i = t)), 0 > (o = o || 1) * (i - n)))
          return [];
    ...
    (goog.userAgent.WEBKIT = goog.userAgent.BROWSER_KNOWN_
      ...
      (jspb.BinaryDecoder.prototype.readFixedHash64 = function () {
        ...
        return (
          (e = e[t + 7]),
          (this.cursor_ += 8),
          String.fromCharCode(o, r, n, i, s, g, a, e)
        );
      }),
      ...
      (jspb.Message.toObjectExtension = function (e, t, o, r, n) {
        for (var i in o) {
          ...
          if (null != g) {
            ...
            t[a] = s.toObjectFn
              ? s.isRepeated
                ? jspb.Message.toObjectList(g, s.toObjectFn, n)
                : s.toObjectFn(n, g)
              : g;
          }
        }
      ...
      (jspb.Message.serializeBinaryExtensions = function (e, t, o, r) {
        for (var n in o) {
          ...
          if (null != g)
            ...
            } else i.binaryWriterFn.call(t, s.fieldIndex, g);
        }
      }),
      ...
      (jspb.Message.computeOneofCase = function (e, t) {
        for (var o, r, n = 0; n < t.length; n++) {
          ...
          null != s && ((o = i), (r = s), jspb.Message.setField(e, i, void 0));
        }
          ...
          for (o = 0; o < i; o++) {
            ...
            if (
              ...
              g &&
                ...
                (n = g),
                (g = void 0)),
              !jspb.Message.compareFields(s, g))
            )
              return !1;
          }
          return (
            (!r && !n) ||
            ((r = r || {}), (n = n || {}), jspb.Message.compareExtensions(r, n))
          );
        }
      ...
      (jspb.Export = {}),
      (_$googleProtobuf_3.Map = jspb.Map),
      (_$googleProtobuf_3.Message = jspb.Message),
      (_$googleProtobuf_3.BinaryReader = jspb.BinaryReader),
      (_$googleProtobuf_3.BinaryWriter = jspb.BinaryWriter),
      (_$googleProtobuf_3.ExtensionFieldInfo = jspb.ExtensionFieldInfo),
      (_$googleProtobuf_3.ExtensionFieldBinaryInfo =
        jspb.ExtensionFieldBinaryInfo),
      (_$googleProtobuf_3.exportSymbol = goog.exportSymbol),
      (_$googleProtobuf_3.inherits = goog.inherits),
      (_$googleProtobuf_3.object = { extend: goog.object.extend }),
      (_$googleProtobuf_3.typeOf = goog.typeOf);
  }.call(
    this,
  ...
  var _$document_pb_5 = {},
    goog = _$googleProtobuf_3,
    __global_5 = Function("return this")();
  goog.exportSymbol("proto.cloud.document.Bar", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Document", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Element", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Element.Case", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Page", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Rect", null, __global_5),
    goog.exportSymbol("proto.cloud.document.Text", null, __global_5),
    (proto.cloud.document.Document = function (e) {
      _$googleProtobuf_3.Message.initialize(
        this,
        e,
        0,
        -1,
        proto.cloud.document.Document.repeatedFields_,
        null
      );
    }),
    goog.inherits(proto.cloud.document.Document, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Document.displayName =
        "proto.cloud.document.Document"),
    (proto.cloud.document.Page = function (e) {
      _$googleProtobuf_3.Message.initialize(
        this,
        e,
        0,
        -1,
        proto.cloud.document.Page.repeatedFields_,
        null
      );
    }),
    goog.inherits(proto.cloud.document.Page, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Page.displayName = "proto.cloud.document.Page"),
    (proto.cloud.document.Element = function (e) {
      _$googleProtobuf_3.Message.initialize(
        this,
        e,
        0,
        -1,
        null,
        proto.cloud.document.Element.oneofGroups_
      );
    }),
    goog.inherits(proto.cloud.document.Element, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Element.displayName =
        "proto.cloud.document.Element"),
    (proto.cloud.document.Bar = function (e) {
      _$googleProtobuf_3.Message.initialize(this, e, 0, -1, null, null);
    }),
    goog.inherits(proto.cloud.document.Bar, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Bar.displayName = "proto.cloud.document.Bar"),
    (proto.cloud.document.Text = function (e) {
      _$googleProtobuf_3.Message.initialize(this, e, 0, -1, null, null);
    }),
    goog.inherits(proto.cloud.document.Text, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Text.displayName = "proto.cloud.document.Text"),
    (proto.cloud.document.Rect = function (e) {
      _$googleProtobuf_3.Message.initialize(this, e, 0, -1, null, null);
    }),
    goog.inherits(proto.cloud.document.Rect, _$googleProtobuf_3.Message),
    goog.DEBUG &&
      !COMPILED &&
      (proto.cloud.document.Rect.displayName = "proto.cloud.document.Rect"),
    (proto.cloud.document.Document.repeatedFields_ = [100]),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Document.prototype.toObject = function (e) {
        return proto.cloud.document.Document.toObject(e, this);
      }),
      (proto.cloud.document.Document.toObject = function (e, t) {
        var o = {
          title: _$googleProtobuf_3.Message.getFieldWithDefault(t, 1, ""),
          pagesList: _$googleProtobuf_3.Message.toObjectList(
            t.getPagesList(),
            proto.cloud.document.Page.toObject,
            e
          ),
        };
        return e && (o.$jspbMessageInstance = t), o;
      })),
    (proto.cloud.document.Document.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Document();
      return proto.cloud.document.Document.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Document.deserializeBinaryFromReader = function (
      e,
      t
    ) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            ...
            break;
          case 100:
            (o = new proto.cloud.document.Page()),
              t.readMessage(
                o,
                proto.cloud.document.Page.deserializeBinaryFromReader
              ),
              e.addPages(o);
            break;
          default:
    ...
    (proto.cloud.document.Document.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Document.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Document.serializeBinaryToWriter = function (e, t) {
      var o = void 0;
      (o = e.getTitle()).length > 0 && t.writeString(1, o),
        (o = e.getPagesList()).length > 0 &&
          t.writeRepeatedMessage(
            100,
            o,
            proto.cloud.document.Page.serializeBinaryToWriter
          );
    }),
    (proto.cloud.document.Document.prototype.getTitle = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 1, "");
    }),
    (proto.cloud.document.Document.prototype.setTitle = function (e) {
      return _$googleProtobuf_3.Message.setProto3StringField(this, 1, e);
    }),
    (proto.cloud.document.Document.prototype.getPagesList = function () {
      return _$googleProtobuf_3.Message.getRepeatedWrapperField(
        this,
        proto.cloud.document.Page,
        100
      );
    }),
    (proto.cloud.document.Document.prototype.setPagesList = function (e) {
      return _$googleProtobuf_3.Message.setRepeatedWrapperField(this, 100, e);
    }),
    (proto.cloud.document.Document.prototype.addPages = function (e, t) {
      return _$googleProtobuf_3.Message.addToRepeatedWrapperField(
        this,
        100,
        e,
        proto.cloud.document.Page,
    ...
    (proto.cloud.document.Document.prototype.clearPagesList = function () {
      return this.setPagesList([]);
    }),
    (proto.cloud.document.Page.repeatedFields_ = [1]),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Page.prototype.toObject = function (e) {
        return proto.cloud.document.Page.toObject(e, this);
      }),
      (proto.cloud.document.Page.toObject = function (e, t) {
        var o = {
          elementsList: _$googleProtobuf_3.Message.toObjectList(
            t.getElementsList(),
            proto.cloud.document.Element.toObject,
            e
          ),
        };
        return e && (o.$jspbMessageInstance = t), o;
      })),
    (proto.cloud.document.Page.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Page();
      return proto.cloud.document.Page.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Page.deserializeBinaryFromReader = function (e, t) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            var o = new proto.cloud.document.Element();
            t.readMessage(
              o,
              proto.cloud.document.Element.deserializeBinaryFromReader
            ),
              e.addElements(o);
            break;
          default:
    ...
    (proto.cloud.document.Page.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Page.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Page.serializeBinaryToWriter = function (e, t) {
      var o;
      (o = e.getElementsList()).length > 0 &&
        t.writeRepeatedMessage(
          1,
          o,
          proto.cloud.document.Element.serializeBinaryToWriter
        );
    }),
    (proto.cloud.document.Page.prototype.getElementsList = function () {
      return _$googleProtobuf_3.Message.getRepeatedWrapperField(
        this,
        proto.cloud.document.Element,
        1
    ...
    (proto.cloud.document.Page.prototype.setElementsList = function (e) {
      return _$googleProtobuf_3.Message.setRepeatedWrapperField(this, 1, e);
    }),
    (proto.cloud.document.Page.prototype.addElements = function (e, t) {
      return _$googleProtobuf_3.Message.addToRepeatedWrapperField(
        this,
        1,
        e,
    ...
    (proto.cloud.document.Page.prototype.clearElementsList = function () {
      return this.setElementsList([]);
    }),
    (proto.cloud.document.Element.oneofGroups_ = [[1, 2, 3]]),
    (proto.cloud.document.Element.Case = {
      __NOT_SET: 0,
      TEXT: 1,
      FORM: 2,
      BAR: 3,
    }),
    (proto.cloud.document.Element.prototype.getCase = function () {
      return _$googleProtobuf_3.Message.computeOneofCase(
        this,
        proto.cloud.document.Element.oneofGroups_[0]
      );
    }),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Element.prototype.toObject = function (e) {
        return proto.cloud.document.Element.toObject(e, this);
      }),
      (proto.cloud.document.Element.toObject = function (e, t) {
        var o,
          r = {
            text: (o = t.getText()) && proto.cloud.document.Text.toObject(e, o),
            form: _$googleProtobuf_3.Message.getFieldWithDefault(t, 2, ""),
            bar: (o = t.getBar()) && proto.cloud.document.Bar.toObject(e, o),
          };
        return e && (r.$jspbMessageInstance = t), r;
      })),
    (proto.cloud.document.Element.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Element();
      return proto.cloud.document.Element.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Element.deserializeBinaryFromReader = function (
      e,
      t
    ) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            var o = new proto.cloud.document.Text();
            t.readMessage(
              o,
              proto.cloud.document.Text.deserializeBinaryFromReader
            ),
              e.setText(o);
            break;
          case 2:
            (o = t.readString()), e.setForm(o);
            break;
          case 3:
            (o = new proto.cloud.document.Bar()),
              t.readMessage(
                o,
                proto.cloud.document.Bar.deserializeBinaryFromReader
              ),
              e.setBar(o);
            break;
          default:
    ...
    (proto.cloud.document.Element.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Element.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Element.serializeBinaryToWriter = function (e, t) {
      var o = void 0;
      null != (o = e.getText()) &&
        t.writeMessage(1, o, proto.cloud.document.Text.serializeBinaryToWriter),
        null != (o = _$googleProtobuf_3.Message.getField(e, 2)) &&
          t.writeString(2, o),
        null != (o = e.getBar()) &&
          t.writeMessage(
            3,
            o,
            proto.cloud.document.Bar.serializeBinaryToWriter
          );
    }),
    (proto.cloud.document.Element.prototype.getText = function () {
      return _$googleProtobuf_3.Message.getWrapperField(
        this,
        proto.cloud.document.Text,
        1
      );
    }),
    (proto.cloud.document.Element.prototype.setText = function (e) {
      return _$googleProtobuf_3.Message.setOneofWrapperField(
        this,
        1,
        proto.cloud.document.Element.oneofGroups_[0],
        e
    ...
    (proto.cloud.document.Element.prototype.clearText = function () {
      return this.setText(void 0);
    }),
    (proto.cloud.document.Element.prototype.hasText = function () {
      return null != _$googleProtobuf_3.Message.getField(this, 1);
    }),
    (proto.cloud.document.Element.prototype.getForm = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 2, "");
    }),
    (proto.cloud.document.Element.prototype.setForm = function (e) {
      return _$googleProtobuf_3.Message.setOneofField(
        this,
        2,
        proto.cloud.document.Element.oneofGroups_[0],
        e
    ...
    (proto.cloud.document.Element.prototype.clearForm = function () {
      return _$googleProtobuf_3.Message.setOneofField(
        this,
        2,
        proto.cloud.document.Element.oneofGroups_[0],
    ...
    (proto.cloud.document.Element.prototype.hasForm = function () {
      return null != _$googleProtobuf_3.Message.getField(this, 2);
    }),
    (proto.cloud.document.Element.prototype.getBar = function () {
      return _$googleProtobuf_3.Message.getWrapperField(
        this,
        proto.cloud.document.Bar,
        3
      );
    }),
    (proto.cloud.document.Element.prototype.setBar = function (e) {
      return _$googleProtobuf_3.Message.setOneofWrapperField(
        this,
        3,
        proto.cloud.document.Element.oneofGroups_[0],
    ...
    (proto.cloud.document.Element.prototype.clearBar = function () {
      return this.setBar(void 0);
    }),
    (proto.cloud.document.Element.prototype.hasBar = function () {
      return null != _$googleProtobuf_3.Message.getField(this, 3);
    }),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Bar.prototype.toObject = function (e) {
        return proto.cloud.document.Bar.toObject(e, this);
      }),
      (proto.cloud.document.Bar.toObject = function (e, t) {
        var o,
          r = {
            rect: (o = t.getRect()) && proto.cloud.document.Rect.toObject(e, o),
          };
        return e && (r.$jspbMessageInstance = t), r;
      })),
    (proto.cloud.document.Bar.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Bar();
      return proto.cloud.document.Bar.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Bar.deserializeBinaryFromReader = function (e, t) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            var o = new proto.cloud.document.Rect();
            t.readMessage(
              o,
              proto.cloud.document.Rect.deserializeBinaryFromReader
            ),
              e.setRect(o);
            break;
          default:
    ...
    (proto.cloud.document.Bar.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Bar.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Bar.serializeBinaryToWriter = function (e, t) {
      var o;
      null != (o = e.getRect()) &&
        t.writeMessage(1, o, proto.cloud.document.Rect.serializeBinaryToWriter);
    }),
    (proto.cloud.document.Bar.prototype.getRect = function () {
      return _$googleProtobuf_3.Message.getWrapperField(
        this,
        proto.cloud.document.Rect,
        1
      );
    }),
    (proto.cloud.document.Bar.prototype.setRect = function (e) {
      return _$googleProtobuf_3.Message.setWrapperField(this, 1, e);
    }),
    (proto.cloud.document.Bar.prototype.clearRect = function () {
      return this.setRect(void 0);
    }),
    (proto.cloud.document.Bar.prototype.hasRect = function () {
      return null != _$googleProtobuf_3.Message.getField(this, 1);
    }),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Text.prototype.toObject = function (e) {
        return proto.cloud.document.Text.toObject(e, this);
      }),
      (proto.cloud.document.Text.toObject = function (e, t) {
        var o,
          r = {
            fontFamily: _$googleProtobuf_3.Message.getFieldWithDefault(
              t,
              1,
              ""
            ),
            fontSize: _$googleProtobuf_3.Message.getFieldWithDefault(t, 2, ""),
            fontWeight: _$googleProtobuf_3.Message.getFieldWithDefault(t, 3, 0),
            rect: (o = t.getRect()) && proto.cloud.document.Rect.toObject(e, o),
            content: _$googleProtobuf_3.Message.getFieldWithDefault(t, 5, ""),
          };
        return e && (r.$jspbMessageInstance = t), r;
      })),
    (proto.cloud.document.Text.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Text();
      return proto.cloud.document.Text.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Text.deserializeBinaryFromReader = function (e, t) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            var o = t.readString();
            ...
            break;
          case 2:
            (o = t.readString()), e.setFontSize(o);
            break;
          case 3:
            (o = t.readInt32()), e.setFontWeight(o);
            break;
          case 4:
            (o = new proto.cloud.document.Rect()),
              t.readMessage(
                o,
                proto.cloud.document.Rect.deserializeBinaryFromReader
              ),
    ...
    (proto.cloud.document.Text.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Text.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Text.serializeBinaryToWriter = function (e, t) {
      var o = void 0;
      (o = e.getFontFamily()).length > 0 && t.writeString(1, o),
        (o = e.getFontSize()).length > 0 && t.writeString(2, o),
        0 !== (o = e.getFontWeight()) && t.writeInt32(3, o),
        null != (o = e.getRect()) &&
          t.writeMessage(
            4,
            o,
            proto.cloud.document.Rect.serializeBinaryToWriter
          ),
        (o = e.getContent()).length > 0 && t.writeString(5, o);
    }),
    (proto.cloud.document.Text.prototype.getFontFamily = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 1, "");
    }),
    (proto.cloud.document.Text.prototype.setFontFamily = function (e) {
      return _$googleProtobuf_3.Message.setProto3StringField(this, 1, e);
    }),
    (proto.cloud.document.Text.prototype.getFontSize = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 2, "");
    }),
    (proto.cloud.document.Text.prototype.setFontSize = function (e) {
      return _$googleProtobuf_3.Message.setProto3StringField(this, 2, e);
    }),
    (proto.cloud.document.Text.prototype.getFontWeight = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 3, 0);
    }),
    (proto.cloud.document.Text.prototype.setFontWeight = function (e) {
      return _$googleProtobuf_3.Message.setProto3IntField(this, 3, e);
    }),
    (proto.cloud.document.Text.prototype.getRect = function () {
      return _$googleProtobuf_3.Message.getWrapperField(
        this,
        proto.cloud.document.Rect,
        4
    ...
    (proto.cloud.document.Text.prototype.setRect = function (e) {
      return _$googleProtobuf_3.Message.setWrapperField(this, 4, e);
    }),
    (proto.cloud.document.Text.prototype.clearRect = function () {
      return this.setRect(void 0);
    }),
    (proto.cloud.document.Text.prototype.hasRect = function () {
      return null != _$googleProtobuf_3.Message.getField(this, 4);
    }),
    (proto.cloud.document.Text.prototype.getContent = function () {
      return _$googleProtobuf_3.Message.getFieldWithDefault(this, 5, "");
    }),
    (proto.cloud.document.Text.prototype.setContent = function (e) {
      return _$googleProtobuf_3.Message.setProto3StringField(this, 5, e);
    }),
    _$googleProtobuf_3.Message.GENERATE_TO_OBJECT &&
      ((proto.cloud.document.Rect.prototype.toObject = function (e) {
        return proto.cloud.document.Rect.toObject(e, this);
      }),
      (proto.cloud.document.Rect.toObject = function (e, t) {
        var o = {
          x: _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
            t,
            1,
            0
          ),
          y: _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
            t,
            2,
            0
          ),
          width: _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
            t,
            3,
            0
          ),
          height: _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
            t,
            4,
            0
          ),
    ...
    (proto.cloud.document.Rect.deserializeBinary = function (e) {
      var t = new _$googleProtobuf_3.BinaryReader(e),
        o = new proto.cloud.document.Rect();
      return proto.cloud.document.Rect.deserializeBinaryFromReader(o, t);
    }),
    (proto.cloud.document.Rect.deserializeBinaryFromReader = function (e, t) {
      for (; t.nextField() && !t.isEndGroup(); )
        switch (t.getFieldNumber()) {
          case 1:
            var o = t.readDouble();
            ...
            break;
          case 2:
            (o = t.readDouble()), e.setY(o);
            break;
          case 3:
            (o = t.readDouble()), e.setWidth(o);
            break;
          case 4:
            (o = t.readDouble()), e.setHeight(o);
            break;
          default:
            t.skipField();
        }
    ...
    (proto.cloud.document.Rect.prototype.serializeBinary = function () {
      var e = new _$googleProtobuf_3.BinaryWriter();
      return (
        proto.cloud.document.Rect.serializeBinaryToWriter(this, e),
        e.getResultBuffer()
      );
    }),
    (proto.cloud.document.Rect.serializeBinaryToWriter = function (e, t) {
      var o = void 0;
      0 !== (o = e.getX()) && t.writeDouble(1, o),
        0 !== (o = e.getY()) && t.writeDouble(2, o),
        0 !== (o = e.getWidth()) && t.writeDouble(3, o),
        0 !== (o = e.getHeight()) && t.writeDouble(4, o);
    }),
    (proto.cloud.document.Rect.prototype.getX = function () {
      return _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
        this,
        1,
        0
      );
    }),
    (proto.cloud.document.Rect.prototype.setX = function (e) {
      return _$googleProtobuf_3.Message.setProto3FloatField(this, 1, e);
    }),
    (proto.cloud.document.Rect.prototype.getY = function () {
      return _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
        this,
        2,
        0
    ...
    (proto.cloud.document.Rect.prototype.setY = function (e) {
      return _$googleProtobuf_3.Message.setProto3FloatField(this, 2, e);
    }),
    (proto.cloud.document.Rect.prototype.getWidth = function () {
      return _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
        this,
        3,
        0
    ...
    (proto.cloud.document.Rect.prototype.setWidth = function (e) {
      return _$googleProtobuf_3.Message.setProto3FloatField(this, 3, e);
    }),
    (proto.cloud.document.Rect.prototype.getHeight = function () {
      return _$googleProtobuf_3.Message.getFloatingPointFieldWithDefault(
        this,
        4,
        0
    ...
    (proto.cloud.document.Rect.prototype.setHeight = function (e) {
      return _$googleProtobuf_3.Message.setProto3FloatField(this, 4, e);
    }),
    goog.object.extend(_$document_pb_5, proto.cloud.document);
  var _$render_6 = {};
  const { Document: Document } = _$document_pb_5,
    putStyle = (e, t) => {
      let o = ["position: absolute", `top: ${e.y}px`, `left: ${e.x}px`, ...t];
      return (
        (0 === e.width && 0 === e.height) ||
          (o = o.concat([`width: ${e.width}px`, `height: ${e.height}px`])),
        o.join(";")
      );
    },
    append = (e, t, o) => {
      let r = [`<${t} `];
      (o = o || {}).style && r.push(`style='${o.style}'`),
        r.push(">"),
        o.text &&
          r.push(
            ((e) => e.replace(/</g, "&lt;").replace(" ", "&nbsp;"))(o.text)
          ),
        r.push(`</${t}>`),
        e.push(r.join(""));
    };
    ...
    ((e) => {
      ...
      for (const r of e.pagesList)
        for (const e of r.elementsList) {
          const { text: r, bar: n } = e;
          r &&
            append(o, "div", {
              style: putStyle(r.rect, [...t(r)]),
              text: r.content,
            }),
            n && append(o, "hr", { style: putStyle(n.rect, []) });
        }
