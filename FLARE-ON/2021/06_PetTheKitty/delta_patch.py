# Original code from: https://wumb0.in/extracting-and-diffing-ms-patches-in-2020.html
...
def apply_patchfile_to_buffer(buf, buflen, patchpath, legacy=False):
    ...
    return apply_delta_to_buffer(buf, buflen, patchbuf, legacy)

def apply_delta_to_buffer(buf, buflen, patch_contents, legacy=False):
